...
class InfoApi(object):
    ...
    def get_placement(self, **kwargs):  # noqa: E501
        ...
        >>> thread = api.get_placement(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_placement_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_placement_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_placement_with_http_info(self, **kwargs):  # noqa: E501
        """Get current placement information, i.e., list of all active VNF instances including their location.  # noqa: E501

          # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_placement_with_http_info(async_req=True)
        >>> result = thread.get()
